  ...
  return(
        ...
        }
      {
        ...
        <Card.Section inheritPadding mb={10}>
          <Center>
            <Button ml='auto' mr='auto' justify='center' leftSection={<CirclePlus />} onClick={() => direccionamientoAgregar({platilloId:platillo_Id, nombre:titulo_platillo, precio:precio_platillo, url:imagenURL_platillo, cantidad: 1 })}>Agregar</Button>
          </Center>
        </Card.Section>
        :
        canEdit ?
